...
export const BarcodeScannerModal: React.FC<BarcodeScannerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4">
      <div className="bg-slate-900 text-white rounded-2xl max-w-md w-full p-5 shadow-2xl border border-slate-700 flex flex-col">
        {/* Header */}
        ...
        <div className="my-4 relative bg-black rounded-xl overflow-hidden min-h-[280px] flex items-center justify-center border border-slate-800">
          ...
          {lastScanned && (
            <div className="absolute bottom-3 left-3 right-3 bg-emerald-950/90 border border-emerald-500/50 text-emerald-200 px-3 py-2 rounded-lg text-xs font-mono flex items-center justify-between animate-fade-in">
